from sqlalchemy import String, Integer, Numeric, Boolean, Date, TIMESTAMP, func, text
...
class OptionPositionSnapshot(Base):
    ...
    asof: Mapped = mapped_column(TIMESTAMP(timezone=True), server_default=func.now())
